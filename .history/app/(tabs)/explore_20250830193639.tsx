...
export default function ExploreScreen() {
  const categories = [
    { id: '1', name: 'Macera', icon: 'trail-sign' },
    { id: '2', name: 'Bilim Kurgu', icon: 'rocket' },
    { id: '3', name: 'Romantik', icon: 'heart' },
    { id: '4', name: 'Gizem', icon: 'search' },
  ];
        ...
        <View className="mb-6">
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {categories.map((category) => (
              ...
              >
                <Ionicons name={category.icon} size={24} color="#3b82f6" />
