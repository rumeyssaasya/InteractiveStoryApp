...
import { getAllProgress } from '../storage/index';
    ...
    try {
      ...
      const recent = recentProgress.map(progress => {
        ...
        return {
          ...progress,
          story,
          lastPlayed: new Date().toLocaleDateString() // Basit bir zaman gösterimi
        };
      }).filter(item => item.story); // Hikayesi olmayanları filtrele
  ...
  return (
    <ScrollView className="flex-1 bg-gray-50">
      <View className="p-4">
        {/* Başlık */}
        <View className="mb-6">
          <Text className="text-3xl font-bold mt-12 text-gray-900">Karar Kutusu</Text>
