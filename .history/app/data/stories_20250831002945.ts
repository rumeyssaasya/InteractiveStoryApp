...
Çevrenizdeki herkes size meraklı gözlerle bakıyor.`,
...

    {
        ...
        '1': { 
            id: '1', 
            title: 'Sisli Giriş', 
            content: `Yoğun sisin içinde ormana adım atıyorsun. Dallardan süzülen ışık huzmeleri sis perdesini hafifçe yırtıyor. Soğuk bir rüzgar yaprakları hışırdatıyor.`, 
            choices: [
        ...
        '4': { 
            ...
            choices: [
                { id: '1', text: 'Risk alıp köprüye çıkmak', nextChapterId: '8' }, 
                { id: '2', text: 'Geri dönüp nehir kıyısında ilerlemek', nextChapterId: '5' }
            ] 
        },
        '5': { 
            id: '5', 
            ...
            choices: [
                { id: '1', text: 'Kütüğü kullanarak karşıya geçmek', nextChapterId: '9' }, 
                { id: '2', text: 'Nehir kıyısında yürümeye devam etmek', nextChapterId: '10' }
            ] 
        },
        '6': { 
            id: '6', 
            ...
            choices: [
                { id: '1', text: 'Yazıtları okumaya çalışmak', nextChapterId: '11' },
                { id: '2', text: 'Masayı incelemek', nextChapterId: '12' }
            ] 
        }
        }
    },
