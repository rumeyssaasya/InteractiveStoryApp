...
export const sampleStories: Story[] = [
  {
    ...
    O sırada etrafınızdaki değişiklikleri fark ediyorsunuz. At arabaları, gaz lambaları ve dumanlı fabrikalar...`, 
        ...
        content: `Rahip sizi kutsal bir odaya götürüyor.Tanrının gücüne sahip olma teklifini yapıyor...`, 
        choices: [
        ...
        id: '7', 
        title: 'Sona Yakın', 
        content: `Zaman makinesine geri dönüyorsunuz. Yolda Rahiple karşılatınız... size tanrıların gücüne sahip olma teklifini yapıyor...`, 
        choices: [
            { id: '1', text: 'Teklifi kabul et', nextChapterId: '8' }, 
            { id: '2', text: 'Reddet ve kaç', nextChapterId: '24' }], 
        isEnding: true
        },
        ...
        id: '10', 
        title: 'Gizli Gelecek', 
        content: `Zaman makinesine giderken geleceğe dair bir ipucu buluyorsunuz...`, 
        choices: [
            { id: '1', text: 'İpuçlarını takip et', nextChapterId: '12' }, 
            { id: '2', text: 'Zaman makinesine gidip düşün.', nextChapterId: '7' }
        ]
        },
        ...
        id: '11', 
        title: 'Zamanın İfşası',  
        content: `Çocuğa ciddi bir şekilde bakıyorsunuz. 
        - Dalga geçmiyorum, dediğinizde gözlerindeki şaşkınlığı görüyorsunuz. 
        Bir an sessizlik oluyor, sonra fısıldar gibi konuşuyor: 
        - O zaman… geleceği görmüş olabilirsin. Ama güç büyük bir sorumluluk demektir.

        Bu sözler sizi düşündürüyor: Zaman yolcusu olmak sadece yolculuk yapmak değil, geleceği şekillendirmek demek olabilir.`,
        choices: [
            { id: '1', text: 'Çocuğun sözlerini ciddiye al ve tanrıların gücüne sahip olmayı kabul et', nextChapterId: '8' },
            { id: '2', text: 'Çocuğa teşekkür et ve kendi yoluna devam ederek kaybolduğunu söyle', nextChapterId: '5' }
        ]
        },
        ...
        content: `Londra sokaklarında ilerliyorsunuz. Sis kalın ve ağır; gaz lambalarının ışığı neredeyse görünmüyor. 
    ...
    Belki de burada zamanın sırları tamamen farklıdır ve burası size tarihin yeni yüzünü gösterecek.`,
        ...
        '24': {
        id: '24',
        title: 'Tüccarların Hikâyeleri',
        content: `Tüccarlarla konuşuyorsunuz. Ülkenin farklı bölgelerinden gelen mallar, hikâyeler ve dedikodular... Bu bilgileri dikkatli kullanırsanız, geçmişteki olayları etkileyebilirsiniz.`,
        choices: [
            { id: '1', text: 'Rahip ile bilgileri paylaş', nextChapterId: '6' },
            { id: '2', text: 'Kendi başına plan yap', nextChapterId: '25' }
        ]
        },

        '25': {
        id: '25',
        title: 'Piramitlerin Gölgeleri',
        content: `Piramitlerin içine giriyorsunuz, gizemli hiyeroglifler duvarları süslüyor. Bir odada eski bir yazıt buluyorsunuz: "Gelecek buradadır, ama gücü dikkatle kullan."`,
        choices: [
            { id: '1', text: 'Yazıtı rahibe göster', nextChapterId: '6' },
            { id: '2', text: 'Yazıtı inceleyip kendi yolunu çiz', nextChapterId: '26' }
        ]
        },

        '26': {
        id: '26',
        title: 'Çocuklarla Oyun',
        content: `Yerel çocuklarla vakit geçiriyorsunuz. Onlardan çevre ve gizli ritüeller hakkında bilgi alıyorsunuz. Bu küçük detaylar, büyük kararlar için ipucu olabilir.`,
        choices: [
            { id: '1', text: 'Rahip ile konuş', nextChapterId: '6' },
            { id: '2', text: 'Piramitlere git', nextChapterId: '25' }
        ]
        }
        }
    },
