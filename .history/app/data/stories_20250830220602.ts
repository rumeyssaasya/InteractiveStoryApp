...
export const sampleStories: Story[] = [
  // Mevcut hikayeler
  {
    ...
    chapters: {
      ...
      '10': {
        id: '10',
        title: 'Gizli Gelecek',
        content: `Zaman makinesinden çıkarken geleceğe dair bir ipucu buluyorsunuz. Bu ipucu sizi daha büyük bir maceraya sürüklüyor.`,
        choices: [
  ...
  // Önceki hikayeler (Kayıp Orman ve Uzay Kolonisi) aynen korunuyor
];
