...
export const sampleStories: Story[] = [
  {
    ...
    chapters: {
      '1': {
        ...
        Profesör Elara:
            - "Dikkatli olun," diyor. "Zaman, hassas bir ipliktir. Küçük bir değişiklik bile büyük sonuçlar doğurabilir."\n\nMakinenin içine adım atıyorsunuz ve kapı yavaşça kapanıyor. Işıklar yanıp sönüyor ve aniden kendinizi farklı bir zamanda buluyorsunuz.`,
        choices: [
          { id: '1', text: '19. yüzyıl Londrasına git', nextChapterId: '2' },
          { id: '2', text: "Antik Mısır'a git", nextChapterId: '3' }
        ]
      },
      '2': { id: '2', title: 'Endüstri Devrimi Londrası', content: `Sisli bir Londra sokağında buluyorsunuz kendinizi...`, choices: [{ id: '1', text: 'Çocuğa zaman yolcusu olduğunu söyle', nextChapterId: '4' }, { id: '2', text: 'Sadece kaybolduğunu söyle', nextChapterId: '5' }] },
      '3': { id: '3', title: 'Antik Mısır', content: `Gözlerinizi açtığınızda piramitlerin gölgesinde bir pazar yerindesiniz...`, choices: [{ id: '1', text: 'Rahip ile konuş', nextChapterId: '6' }, { id: '2', text: 'Kalabalığa karış ve kaç', nextChapterId: '7' }] },
      '4': { id: '4', title: 'Zamanın İfşası', content: `Çocuğa gerçeği söylüyorsunuz...`, choices: [], isEnding: true },
      '5': { id: '5', title: 'Kayıp Yolcu', content: `Kaybolduğunuzu söylüyorsunuz...`, choices: [], isEnding: true },
      '6': { id: '6', title: 'Tanrıların Sırrı', content: `Rahip sizi kutsal bir odaya götürüyor...`, choices: [{ id: '1', text: 'Teklifi kabul et', nextChapterId: '8' }, { id: '2', text: 'Reddet ve kaç', nextChapterId: '5' }] },
      '7': { id: '7', title: 'Son', content: `Zaman makinesine geri dönmeyi başardınız...`, choices: [], isEnding: true },
      '8': { id: '8', title: 'Tanrıların Gücü', content: `Teklifi kabul ettiniz ve tanrıların gücüne sahip oldunuz...`, choices: [{ id: '1', text: 'Gücü dünyayı kurtarmak için kullan', nextChapterId: '9' }, { id: '2', text: 'Gücü reddet ve normale dön', nextChapterId: '7' }] },
      '9': { id: '9', title: 'Kurtarıcı', content: `Zamanın gücünü kullanarak dünyayı büyük bir felaketten kurtardınız...`, choices: [], isEnding: true },
      '10': { id: '10', title: 'Gizli Gelecek', content: `Zaman makinesinden çıkarken geleceğe dair bir ipucu buluyorsunuz...`, choices: [{ id: '1', text: 'İpuçlarını takip et', nextChapterId: '9' }, { id: '2', text: 'Makineyi geri bırak', nextChapterId: '7' }] }
    }
  },
