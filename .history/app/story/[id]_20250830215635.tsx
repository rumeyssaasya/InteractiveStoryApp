...
import { clearUserProgress, saveUserProgress } from '../storage';
...
export default function StoryReader() {
  ...
  const handleChoiceSelect = async (choiceId: string, nextChapterId: string) => {
    ...
    setTimeout(async () => {
      ...
      // Eğer son bölümse otomatik yönlendirme yerine progress göstermek için sadece completed flag
