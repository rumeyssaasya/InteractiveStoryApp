...
export const sampleStories: Story[] = [
  ...
  
  {
    ...
    id: '1',
    title: 'Kırmızı Gece',
    content: `Mars'ta ilk geceniz. Kırmızı toz fırtınası yaklaşmakta. Kapsülünüzün penceresinden dışarıya bakıyorsunuz, ufukta fırtınanın kızıl bulutları beliriyor.`,
    choices: [
...
'2': {
    ...
    content: `Dışarı çıkınca uzak bir yerden bilinmeyen bir sinyal alıyorsunuz. Sinyal tuhaf ve ritmik, sanki bir mesaj içeriyor.`,
    choices: [
        { id: '1', text: 'Sinyali takip et', nextChapterId: '4' },
        { id: '2', text: 'Sinyali görmezden gel ve kampına geri dön', nextChapterId: '5' }
    ]
},
'3': {
    id: '3',
    title: 'Kapsül Güvenli',
    content: `Kapsülünüz güvenli ve sağlam. Dışarı çıkmak tehlikeli olabilir. Fırtına yaklaştıkça dışarısı kırmızı bir gölgeye bürünüyor.`,
    choices: [
        { id: '1', text: 'Fırtınadan sonra dışarı çık', nextChapterId: '6' },
        { id: '2', text: 'Kapsülde dinlen ve verileri incele', nextChapterId: '7' }
    ]
},
'4': {
    id: '4',
    title: 'Kayıp Koloni',
    content: `Sinyali takip edince terk edilmiş bir koloni buluyorsunuz. Kırılmış cihazlar, boş kapsüller ve bilinmeyen yazıtlar dikkat çekiyor. Atmosfer sessiz ama bir şey sizi izliyor gibi.`,
    choices: [
        { id: '1', text: 'Koloniyi incele ve ipuçları topla', nextChapterId: '8' },
        { id: '2', text: 'Koloniyi terk et ve güvenli bölgeye dön', nextChapterId: '5' },
        { id: '3', text: 'Sinyali analiz etmeye devam et', nextChapterId: '9' }
    ]
},
'5': {
    id: '5',
    title: 'Yeni Başlangıç',
    content: `Mars'ta yeni bir kamp kuruyorsunuz. Çadırlar yerleştirildi, cihazlar aktif. Yavaş yavaş bölgeyi keşfetmeye başlıyorsunuz.`,
    choices: [
        { id: '1', text: 'Yakındaki kraterleri keşfet', nextChapterId: '10' },
        { id: '2', text: 'Kampın etrafında güvenlik turu yap', nextChapterId: '11' }
    ]
},
'6': {
    id: '6',
    title: 'Fırtına Sonrası',
    content: `Fırtına sona erdi. Kızıl tozlar havada asılı kalmış. Dışarıda yeni oluşan yollar ve çökmüş kayalar görüyorsunuz. Belki de bu değişiklikler sizi sinyalin kaynağına götürebilir.`,
    choices: [
        { id: '1', text: 'Yeni yolları takip et', nextChapterId: '4' },
        { id: '2', text: 'Kapsüle dön ve bekle', nextChapterId: '3' }
    ]
},
'7': {
    id: '7',
    title: 'Veri İncelemesi',
    content: `Kapsülde kalıp sinyali ve çevre verilerini inceliyorsunuz. Cihazlar eski koloniden gelen enerjik dalgaları ve olası tehlikeleri rapor ediyor.`,
    choices: [
        { id: '1', text: 'Koloniye gitmeye karar ver', nextChapterId: '4' },
        { id: '2', text: 'Yeni kamp kur ve araştırmaya devam et', nextChapterId: '5' }
    ]
},
'8': {
    id: '8',
    title: 'Koloninin Sırları',
    content: `Koloniyi detaylı inceliyorsunuz. Bir kayıt cihazı çalışır durumda ve bir mesaj içeriyor: "Bizi takip etmeyin. Tehlike yaklaşıyor."`,
    choices: [
        { id: '1', text: 'Mesajı dikkate al ve uzaklaş', nextChapterId: '5' },
        { id: '2', text: 'Tehlikeyi göze al ve ileri git', nextChapterId: '12' }
    ]
},
'9': {
    id: '9',
    title: 'Sinyal Analizi',
    content: `Sinyali analiz ettikçe yapay bir zeka imzası fark ediyorsunuz. Belki de Mars'ta bilinmeyen bir teknoloji sizi izliyor.`,
    choices: [
        { id: '1', text: 'İleri git ve kaynağı araştır', nextChapterId: '12' },
        { id: '2', text: 'Kampınıza geri dön', nextChapterId: '5' }
    ]
},
'10': {
    id: '10',
    title: 'Krater Keşfi',
    content: `Kraterlerin içinde tuhaf mineral oluşumları ve eski yapılar görüyorsunuz. Bu keşif insanlık tarihini değiştirebilir.`,
    choices: [
        { id: '1', text: 'Kraterin derinliklerine in', nextChapterId: '13' },
...
'11': {
    id: '11',
    title: 'Güvenlik Turu',
    content: `Kampın çevresini kontrol ediyorsunuz. Bazı sinyal bozuklukları ve ışık parlamaları fark ediyorsunuz. Tehlike olasılığı var.`,
    choices: [
        { id: '1', text: 'Parlamaları takip et', nextChapterId: '12' },
...
'12': {
    ...
    content: `Sinyalin ve ışık parlamalarının kaynağına ulaşıyorsunuz. Eski bir koloninin yer altı laboratuvarı ve aktif cihazlar burada. Gizemli bir enerji hissediyorsunuz.`,
    choices: [
        { id: '1', text: 'Laboratuvarı incele', nextChapterId: '14' },
...
'13': {
    ...
    content: `Kraterin derinliklerinde eski bir uzay aracı kalıntısı buluyorsunuz. İçinde kayıt cihazları ve enerji çekirdekleri var.`,
    choices: [
        { id: '1', text: 'Enerji çekirdeklerini al', nextChapterId: '15' },
        { id: '2', text: 'Sadece kayıt cihazlarını al', nextChapterId: '16' }
    ]
},
'14': {
    id: '14',
    title: 'Laboratuvar Sırrı',
    content: `Laboratuvarı inceliyorsunuz. Cihazlar çalışıyor ve Mars'ta kayıp bir teknolojinin izlerini gösteriyor. Büyük bir keşif bu.`,
    choices: [],
    isEnding: true
},
'15': {
    ...
    content: `Enerji çekirdeğini aldınız. Bu, Mars kolonisi için büyük bir güç kaynağı olabilir. Ancak risk büyük.`,
...
'16': {
    ...
    content: `Kayıt cihazlarını aldınız. İçlerinde Mars'ın eski kolonisi hakkında önemli bilgiler var. Gelecekte kullanabileceğiniz değerli bir kaynak.`,
